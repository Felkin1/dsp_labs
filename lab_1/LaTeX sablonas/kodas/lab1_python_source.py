...
# %%
# c.) sumodeliuojame D ir B stygas, pavaizduojame ju laiko ir dazniu vaizdus
# randame pirmuju triju harmoniku daznius. Aptarti pastebetus spektru panasumus ir skirtumus
fd = 44100
...
axs[0,1].set_title("D stygos signalas dazniu srityje")
axs[1,1].set_title("B stygos signalas dazniu srityje")

fig.suptitle("D ir B stygu modeliavimas; apribotos X asys")

plt.show()

# TODO - harmoniku dazniai
...
axs[1].set_title("Akordo signalas dazniu srityje")
...
# %%
# Raskite akordo pirmuju penkiu harmoniku daznius. Ar sie dazniai sutampa su akordo atskiru stygu virpejimo dazniais?
...
for i in range(len(K)):
    ...
    axs[i,1].set_title(f"Akordo signalas dazniu srityje, K={K[i]}")


#fig.suptitle("Iskraipyto Akordo modeliavimas su skirtingomis K reiksmemis")
plt.show()
...
axs[1,1].set_xlim([0,400])
axs[1,1].set_ylim([-80,0])
axs[1,1].set_title("Akordo signalas dazniu srityje; amplitudine moduliacija")
...
axs[2,1].set_title("Akordo signalas dazniu srityje; ziedine moduliacija")
